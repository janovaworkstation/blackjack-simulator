        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-red-50 p-4 rounded-lg">
              ...
              <div
                className={`text-xl font-bold ${safeResults.expectedValue >= 0 ? 'text-green-600' : 'text-red-600'}`}
              >
            ...
            <div className="bg-purple-50 p-4 rounded-lg">
              ...
              <div
                className={`text-xl font-bold ${safeResults.netResult >= 0 ? 'text-green-600' : 'text-red-600'}`}
              >
                $
                {parseFloat(safeResults.netResult.toFixed(2)).toLocaleString(
                  'en-US',
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    $
                    {parseFloat(
                      safeResults.totalWagered.toFixed(2),
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    $
                    {parseFloat(
                      (safeResults.totalWagered + safeResults.totalWon).toFixed(
                        2,
                      ),
                    ).toLocaleString('en-US', {
                      minimumFractionDigits: 2,
                ...
                <div className="flex justify-between">
                  ...
                  <span
                    className={`font-medium ${safeResults.netResult >= 0 ? 'text-green-600' : 'text-red-600'}`}
                  >
                    $
                    {parseFloat(
                      safeResults.netResult.toFixed(2),
                    ).toLocaleString('en-US', {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-red-600 font-medium">
                    $
                    {parseFloat(
                      safeResults.maxDrawdown.toFixed(2),
                    ).toLocaleString('en-US', {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
          ...
          <div className="text-center">
            <div className="text-xs text-gray-500">
              Total: {safeResults.totalOutcomes.toLocaleString()} outcomes from{' '}
              {safeResults.handsPlayed.toLocaleString()} hands dealt (includes
              splits)
            </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div
                    className={`text-lg font-bold ${safeResults.expectedValue >= 0 ? 'text-green-600' : 'text-red-600'}`}
                  >
                    $
                    {(
                      ((safeResults.averageBetSize *
                        safeResults.expectedValue) /
                        100) *
                ...
                <div>
                  ...
                  <div
                    className={`text-lg font-bold ${
                      safeResults.maxDrawdown / safeResults.totalWagered < 0.1
                        ? 'text-green-600'
                        : safeResults.maxDrawdown / safeResults.totalWagered <
                            0.2
                          ? 'text-yellow-600'
                          : 'text-red-600'
                    }`}
                  >
                    {safeResults.maxDrawdown / safeResults.totalWagered < 0.1
                      ? 'Low'
                      : safeResults.maxDrawdown / safeResults.totalWagered < 0.2
                        ? 'Medium'
                        : 'High'}
                  </div>
                </div>
